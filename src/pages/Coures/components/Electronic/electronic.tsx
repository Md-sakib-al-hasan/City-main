...
import eleteric from "../../../../../public/man1.jpg"

const ElectroicCourse =() => {
    ...
    return (
        <div className="lg:grid grid-cols-4  gap-5 w-11/12 max-w-[1280px]  mx-auto">
            <div className="col-span-3 ">
             <img src="https://i.ibb.co.com/r2CY6yf/top-view-wires-tech-background.jpg" alt="demo" className="h-[500px] w-full object-cover " />
             <ul className='text-lg font-bold text-[#131d3b] sm:flex xl:gap-16 gap-6 bg-[#f4f6f9] mt-5  sm:space-y-0 space-y-10'>
                <li className='flex gap-2 '>
                <img src={eleteric} alt="" className='w-[60px]  h-auto object-cover' />
                <span className=''>
                    <span className="capitalize block">Instructor</span>
                    <span className="capitalize">Md. Rakib Hasan</span>
                </span>
                </li>
            ...
            <ul className='capitalize font-bold sm:text-lg  text-[#131d3b] bg-[#f4f6f9] mt-16 flex justify-evenly items-center text-center'>
             ...
             <div  className={`${activestate==2?"block":"hidden"} mt-10 `}>
               <figure className='col-span-1 flex  flex-col justify-center items-center'>
                <img className='h-[145px] w-auto object-cover' src={eleteric} alt="" />
                <h4 className='font-bold capitalize text-center pt-5'>Md. Rakib Hasan</h4>
               </figure>
             ...
             <div>
                <ul className=''>
                    <li className='bg-[#f3f2f6] p-5 sm:flex gap-4'>
                        <span>
                            <img src={eleteric} className='max-h-[120px] object-cover' alt="" />
                        </span>
                        <span className=''>
...
export default ElectroicCourse;